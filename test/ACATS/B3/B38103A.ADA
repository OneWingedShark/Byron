...
BEGIN
     DECLARE
          ...
          TYPE T16C (D : NP3.T) IS           -- OK.
               RECORD NULL; END RECORD;

          TYPE T17 (D : B38103A.P3.T) IS     -- OK: (I) B38103A.P3.T.
               RECORD NULL; END RECORD;

          TYPE T18 (D : I := F1(1,0)) IS     -- ERROR: (E) DIFFERENT F1.
               RECORD NULL; END RECORD;

          TYPE T19A (D : I := STANDARD."+"(1,0)) IS    -- OK.
               RECORD NULL; END RECORD;

          TYPE T19B (D : CHARACTER := 'A') IS          -- OK.
               RECORD NULL; END RECORD;
