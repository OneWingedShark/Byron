...
-- CASE D: THE INCOMPLETE DECLARATION IS IN A PACKAGE PRIVATE PART AND
--         THE FULL DECLARATION IS IN THE CORRESPONDING PACKAGE BODY,
--         WHICH IS COMPILED AS A SUBUNIT IN THE SAME COMPILATION FILE.
...
PROCEDURE B38103D IS
     ...
     PRIVATE
          ...
          PACKAGE P5 IS
               V1 : I RENAMES B38103D.V1;
               SUBTYPE I IS B38103D.I;
          END P5;
     ...
     PACKAGE BODY B38103D1 IS SEPARATE;
...
PACKAGE BODY B38103D1 IS
    ...
    TYPE T9C (D : I2 := "+"(2,0)) IS   -- OK by Ada95 rules
     ...
     TYPE T17 (D : B38103D.P3.T) IS     -- OK: (I) B38103D.P3.T.
          RECORD NULL; END RECORD;
