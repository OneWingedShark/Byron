...
Package Body Byron.Internals.SPARK.Pure_Types.Vector with SPARK_Mode => Off is
   ...
   "<"          => "<");
	...
	if Bounded then
	    ...
	    if Capacity > Pure_Types.Vector.Capacity(Container) then
		declare
...
End Byron.Internals.SPARK.Pure_Types.Vector;
